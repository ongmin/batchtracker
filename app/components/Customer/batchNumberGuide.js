    ...
    return (
      ...
      <h1>Where can I find the Batch Code?</h1>
        ...
        <div className='batch-code-images'>
          <img src='http://s3.amazonaws.com/batchtracker-app/images/01guide.jpg' />
          <img src='http://s3.amazonaws.com/batchtracker-app/images/02guide.jpg' />
          <img src='http://s3.amazonaws.com/batchtracker-app/images/03guide.jpg' />
        </div>
      </div>
    )
  }
